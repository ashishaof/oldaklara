		...
		<div class="display-table center-text">
			<div class="display-table-cell">
				<div class="slider-content">
					...
					<h5 class="date">Saturday, The 20th of July 2019</h5>
					<h3 class="pre-title">Save Our Date</h3>
					<h1 class="title">Klara <i class="icon icon-heart"></i> Oldrich</h1>

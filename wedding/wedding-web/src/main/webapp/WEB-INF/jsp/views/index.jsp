		...
		<div class="display-table center-text">
			<div class="display-table-cell">
				<div class="slider-content">
					...
					<h5 class="date">Sobota, 20. Července 2019</h5>
					<h3 class="pre-title"></h3>
					<h1 class="title">Klárka <i class="icon icon-heart"></i> Olda</h1>
	...
	<section class="section counter-area center-text">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="heading">
						<h2 class="title">Už se to blíží!</h2>
				...
				<div class="col-sm-10">
					...
					<div class="wedding-details margin-bottom">
						...
						<div class="w-detail right">
							...
							<h4 class="title">Katedrála sv. Petra a Pavla</h4>
						</div><!-- w-detail -->
						
						<div class="w-detail left">
							<i class="icon icon-camera"></i>
              	<h4 class="title">Fotografování­</h4>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="heading">
						<h2 class="title">Těšíme se na Vás!</h2>
						<span class="heading-bottom"><i class="color-white icon icon-star"></i></span>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-10">
						...
						<div class="margin-bottom">
							<p>20. Července 2019</p>
							
							<p>Petrov 9, 602 00 Brno 2</p>
